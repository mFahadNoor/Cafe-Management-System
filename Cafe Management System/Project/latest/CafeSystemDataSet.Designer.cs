...
namespace latest {
    ...
    public partial class CafeSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class itemDataTable : global::System.Data.TypedTableBase<itemRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public itemRow AdditemRow(int id, string name, int quantity, decimal price) {
...
namespace latest.CafeSystemDataSetTableAdapters {
    ...
    public partial class itemTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[item] WHERE (([id] = @Original_id) AND ([name] = @Original_nam" +
                "e) AND ([quantity] = @Original_quantity) AND ([price] = @Original_price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[item] ([id], [name], [quantity], [price]) VALUES (@id, @name, " +
                "@quantity, @price);\r\nSELECT id, name, quantity, price FROM item WHERE (id = @id)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[item] SET [id] = @id, [name] = @name, [quantity] = @quantity, [price] = @price WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([quantity] = @Original_quantity) AND ([price] = @Original_price));
SELECT id, name, quantity, price FROM item WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::latest.Properties.Settings.Default.CafeSystemConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, quantity, price FROM dbo.item";
        ...
        public virtual int Fill(CafeSystemDataSet.itemDataTable dataTable) {
        ...
        public virtual CafeSystemDataSet.itemDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CafeSystemDataSet.itemDataTable dataTable = new CafeSystemDataSet.itemDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CafeSystemDataSet.itemDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, int Original_quantity, decimal Original_price) {
        ...
        public virtual int Insert(int id, string name, int quantity, decimal price) {
        ...
        public virtual int Update(int id, string name, int quantity, decimal price, int Original_id, string Original_name, int Original_quantity, decimal Original_price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, int quantity, decimal price, int Original_id, string Original_name, int Original_quantity, decimal Original_price) {
